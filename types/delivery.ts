// ============================================================================
// DELIVERY OPERATIONS & COVERAGE TYPES
// ============================================================================
...
// --- Phase 4: Competitor-Aware No-Orders Block Analysis ---

export type NoOrderBlockClassification =
...
export interface NoOrderBlockAnalysis {
  blockNumber: string;
  areaName?: string | null;
  governorate?: Governorate | null;
...
export interface NoOrdersBreakdownSummary {
  totalNoOrderBlocks: number;
  contestedCount: number;
  contestedSingleCompetitorCount: number;
  whiteSpaceCount: number;
  saturatedCount: number;
  outsideServiceAreaCount: number;
  contestedBlocks: NoOrderBlockAnalysis[];
  whiteSpaceBlocks: NoOrderBlockAnalysis[];
  saturatedBlocks: NoOrderBlockAnalysis[];
  outsideServiceAreaBlocks: NoOrderBlockAnalysis[];
}
