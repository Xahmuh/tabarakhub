...
Migration history is reconciled on the linked Supabase project: the seven schema-present/manual-applied migrations were repaired as applied, 20260613103000, 20260613131500, and 20260613134500 were applied with explicit approval, and Spin Static QR remediation 20260614150000_harden_spin_static_qr_exchange_rpc.sql was applied with explicit approval. `supabase.cmd migration list --linked` shows no observed local-only or remote-only gaps. Do not run blind `supabase db push`; review future changes intentionally.
